...
- Does OpenCode failure fall back to Codex Spark through explicit model selection, GitHub Copilot, or another verified free helper without using standard Codex as a delegated agent?

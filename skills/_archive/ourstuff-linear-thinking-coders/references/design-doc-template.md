...
- `Execution backend:` Codex Spark CLI | GitHub Copilot | OpenCode/free | no delegated backend
...
- `Fallback rule:` no standard Codex delegated agents; use Spark via explicit model selection, GitHub Copilot, OpenCode/free, or stop delegation
